      ...
      <List>
        ...
        >
          <ListItem button>
            ...
            <ListItemText className="text-black" primary="Pay" />
          </ListItem>
        </NavLink>
        <NavLink
          style={{
        ...
        >
          <ListItem button>
            ...
            <ListItemText className="text-black" primary="My Orders" />
          </ListItem>
        </NavLink>
        <NavLink
          style={{
        ...
        >
          <ListItem button>
            ...
            <ListItemText className="text-black" primary="Review" />
          </ListItem>
        </NavLink>
        ...
        >
          <Switch>
            <Route exact path={path}>
              <h2 className="text-center text-black my-5">
