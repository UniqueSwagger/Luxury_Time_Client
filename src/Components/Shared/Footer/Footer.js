    ...
    <div>
      <footer className="footer">
        <div className="footer__addr">
          <h1 className="footer__logo">Luxury Time</h1>
        ...
        <ul className="footer__nav">
          <li className="nav__item">
            <h2 className="nav__title">watches</h2>

            <ul className="nav__ul">
              <li>
                <a href="#watches">Rolex</a>
              </li>
              <li>
                <a href="#watches">Men's Watch</a>
              </li>

              <li>
                <a href="#watches">Women's Watch</a>
              </li>
            </ul>
          </li>
        ...
        <div className="legal">
          <p>&copy; 2021 Luxury Time. All rights reserved.</p>
